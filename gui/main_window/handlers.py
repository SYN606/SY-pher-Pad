...
class WindowHandlers:
    """Handles all business logic for the MainWindow."""
    ...
    def show_settings_dialog(self) -> None:
        dialog = SettingsDialog(self.window.document, self.window)
        dialog.exec()
    ...
    def open_document(self) -> None:
        ...
        try:
            ...
            document.setModified(False)
            self.window._update_title()
            self.window.status_bar.showMessage(f"Opened {path.name}", 3000)
    ...
    def save_document(self) -> None:
        ...
        try:
            ...
            self.window.document.save_encrypted(
                plain_text,
                password,
            )
